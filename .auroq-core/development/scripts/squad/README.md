...
```javascript
const { SquadLoader } = require('./.auroq-core/development/scripts/squad');
...
```javascript
const { SquadLoader, SquadLoaderError } = require('./.auroq-core/development/scripts/squad');
...
# Run with coverage
npm test -- tests/unit/squad/squad-loader.test.js --coverage --collectCoverageFrom=".auroq-core/development/scripts/squad/*.js"
```
