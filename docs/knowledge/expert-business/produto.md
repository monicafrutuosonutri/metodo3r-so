...
|-----------|-----------|
| Escala de Fome | Desenvolve consciência dos sinais do corpo |
| Diário Alimentar e Comportamental | Identifica padrões, gatilhos e conexões emoções-alimentação |
| Pausa Consciente | Cria espaço entre impulso e ação para escolhas mais conscientes |
...
| Antes | Depois |
|-------|--------|
| Medo do reganho | Confiança |
| Insegurança | Autonomia |
| Vigilância constante | Segurança |
| Dependência emocional do medicamento | Relação mais leve com a comida |
...
## Visão de expansão — Internacional

A dor que o método resolve não é exclusiva do Brasil. Mulheres do mundo inteiro que utilizaram medicamentos para emagrecimento enfrentam os mesmos desafios: medo do reganho, insegurança alimentar, dependência emocional do tratamento.

**Intenção futura:** adaptar a metodologia para outros idiomas e mercados.

**Frase-guia:** "Validar localmente. Escalar globalmente."
