...
**Load:** `data/clone-validation.yaml` + `data/output-examples.yaml`
...
Usar `clone-validation.yaml` para avaliar cada camada:
...
Usar `output-examples.yaml` como referencia de voz esperada.
