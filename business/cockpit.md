...
|----------|-------------|--------|-----------------|
| Tráfego pago | Equipe externa | Rodando | Sem análise desde 07/06 |
| Página de vendas | Equipe externa | **Status não confirmado** | LP Confiança Blindada aprovada em 12/07 — não confirmado se está no ar |
| Aplicativo Confiança Blindada | Equipe externa | Rodando | — |
...
8. **Status não confirmado é status válido** — nenhum agente marca algo como feito sem evidência
